...
class Login extends Component {
  ...
  handleSubmit = e => {
    ...
    // const values = form.getFieldsValue()//得到的是全部的input value  是一个对象
    // const username = form.getFieldValue('username')//得到某个具体的value
  ...
  */
  ...
  render() {
    ...
    //getFieldDecorator函数  form是一个对象 里面有getFieldDecorator这个方法
